...
#Disable Warning BC42104 ' Переменная используется до того, как ей было назначено значение
            ...
            If languagesetgs = "ru" Then
                ...
                warninglabel.Content = "Автообновление приостановлено для сохранения быстрой работы приложения."
            ...
            If languagesetgs = "ua" Then
                ...
                warninglabel.Content = "Автоматичне оновлення призупинено для збереження швидкої роботи програми."
                rratevaluelabel.Content = Convert.ToString(Math.Round(rrateslider.Value)) + " с."
            ...
            If languagesetgs = "de" Then
                ...
                title.Content = "DMITComp Zeitzähler"
                ...
                closeFrameBtn.Content = "Schließen"
                ...
                warninglabel.Content = "Automatische Updates werden angehalten, damit de Anwendung schnell läuft."
                rratevaluelabel.Content = Convert.ToString(Math.Round(rrateslider.Value)) + " s."
